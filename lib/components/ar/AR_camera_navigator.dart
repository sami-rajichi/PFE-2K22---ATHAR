...
class ARcameraNavigator extends StatefulWidget {
  
  const ARcameraNavigator({Key? key}) : super(key: key);

  @override
  State<ARcameraNavigator> createState() => _ARcameraNavigatorState();
}

class _ARcameraNavigatorState extends State<ARcameraNavigator> {
  MI currentItem = MenuItems.ar;
  @override
