...
class ConsultMonument extends StatefulWidget {
  final String? name;
  final String? info;
  ...
  @override
  State<ConsultMonument> createState() => _ConsultMonumentState();
}

class _ConsultMonumentState extends State<ConsultMonument> {
