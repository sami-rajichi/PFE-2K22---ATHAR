    ...
    for (Monument e in monuments) {
      if (e.name == name) {
        return CategoryPage(
          ...
          location: e.location,
          region: e.region,
          subtitle1: e.subtitle1,
          subtitle1Value: e.subtitle1Value,
          subtitle2: e.subtitle2,
          subtitle2Value: e.subtitle2Value,
          subtitle3: e.subtitle3,
          subtitle3Value: e.subtitle3Value,
          info: e.info,
          url: e.url,
